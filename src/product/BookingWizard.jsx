...
export function BookingWizard({
  ...
  const fill = () => {
    const sample = sampleDraft(d.legs.length, d.adults);
            ...
            {d.step === 0 && (
              <>
                  ...
                  >
                    <div className="field-grid">
                      ...
                      <Field
                        ...
                        value={l.date}
                        onChange={(e) => changeLeg(i, { date: e.target.value })}
                      />
                      <Field
                ...
                <div className="add-flight-action">
                  ...
                  >
                    <span className="add-flight-plus" aria-hidden="true">+</span>
                    Add another flight
                  </Button>
                </div>
                <Card title="Who is travelling?">
                  ...
                  <p className="fine">
                    ...
                    adults only. Search over 3,200 airports by city, country or
                    airport code.
                  </p>
                </Card>
              </>
            ...
            {d.step === 2 && (
              <>
                <p className="note">
                  ...
                  not confirm supplier coverage; no real services are reserved.
                </p>
            ...
            {d.step === 3 && (
              <>
                <Card title="Journey & travellers">
                  ...
                  {d.legs.map((l, i) => (
                    <p key={l.id}>
                      Flight {i + 1} · {l.from} → {l.to} · {l.date} · {l.flight}
                    </p>
                  ))}
                  <hr />
                  {d.travellers.map((t, i) => (
                ...
                <p className="note">
                  ...
                  illustrative. Confirming saves a demo booking, not an airport
                  reservation.
                </p>
              </>
            )}
            {d.step === 4 && (
              <>
                ...
                <Card title="Confirm against your credit facility">
                  <p>
                    The discounted amount is deducted from this session’s credit
                    facility.
                  </p>
